...
const FILE_VARIANTS = {
  week1: ['inventory', 'profile', 'pricetag', 'formula', 'compare', 'formula', 'listops', 'status', 'formula'],
  week2: ['profile', 'formula', 'profile', 'listops', 'formula', 'rules', 'timeline', 'timeline', 'form'],
