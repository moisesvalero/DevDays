...
export const week5: Leccion[] = [
  {
    ...
    contenido: contenidoLab(
      'dia-29-typescript',
      'Laboratorio: tipos en componentes de producto.',
      ['Interface Producto', 'Props tipadas', 'Union types']
    ),
    ejercicios: [
      ej(
        1,
  ...
  },
  {
    ...
    contenido: contenidoLab(
      'dia-30-env',
      'Laboratorio: env y hooks.server.',
      ['Variables públicas', 'Secrets servidor', 'hooks.server']
    ),
    ejercicios: [
      ej(
        1,
  ...
  },
  {
    ...
    contenido: contenidoLab(
      'dia-31-deploy',
      'Laboratorio: pipeline de deploy Vercel.',
      ['Pipeline', 'Preview', 'Env prod']
    ),
    ejercicios: [
      ej(
        1,
  ...
  },
  {
    ...
    contenido: contenidoLab(
      'dia-32-stack-story',
      'Laboratorio: pitch de 2 minutos.',
      ['Problema de negocio', 'Stack elegido', 'Demo en vivo']
    ),
    ejercicios: [
      ej(
        1,
  ...
  },
  {
    ...
    contenido: contenidoLab(
      'dia-34-proyecto',
      'Laboratorio: guiar demo del proyecto.',
      ['Hook (15s)', 'Demo guiada', 'Next steps']
    ),
    ejercicios: [
      ej(
        1,
