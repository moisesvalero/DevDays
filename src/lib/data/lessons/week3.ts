...
export const week3: Leccion[] = [
  ...
  },
  {
    ...
    contenido: contenidoLab(
      'dia-17-state',
      'Laboratorio: $state en UI de producto.',
      ['Contador', 'Toggle UI', 'Formulario']
    ),
    ejercicios: [
      ej(
        1,
  ...
  },
  {
    ...
    contenido: contenidoLab(
      'dia-18-derived',
      'Laboratorio: $derived y $effect.',
      ['Precio + IVA', 'Stock bajo', 'Log simulado']
    ),
    ejercicios: [
      ej(
        1,
  ...
  },
  {
    ...
    contenido: contenidoLab(
      'dia-19-props',
      'Laboratorio: $props en cards reutilizables.',
      ['Props obligatorias', 'Default props', 'Props tipadas']
    ),
    ejercicios: [
      ej(
        1,
  ...
  },
  {
    ...
    contenido: contenidoLab(
      'dia-20-eventos',
      'Laboratorio: onclick y bind: en formularios.',
      ['onclick', 'bind:value', 'bind:checked']
    ),
    ejercicios: [
      ej(
        1,
