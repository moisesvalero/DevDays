...
<section class="rounded-lg border border-outline-variant bg-surface-container-low p-5">
	...
	<p class="mb-4 text-sm text-on-surface-variant">
		{#if esRepaso}
			Descarga el <strong>repaso de toda la semana {lesson.semana}</strong> para un audio un poco más
			largo. Luego haz los retos del examen aquí.
		{:else}
	...
	<div class="flex flex-wrap gap-2">
		...
		<Button href={NOTEBOOKLM_URL} target="_blank" rel="noopener noreferrer" variant="outline">
