...
<InteractiveLabLayout hint="Objeto producto — propiedades nombre y precio alimentan la card.">
	{#snippet preview()}
		<article
			class="lab-card-lift mx-auto max-w-sm overflow-hidden rounded-2xl border border-outline-variant/50 bg-card shadow-lg"
		>
			...
			<div class="p-5 space-y-3">
				<input
					...
					class="w-full text-xl font-bold bg-transparent border-b border-outline-variant/50"
				/>
				<div class="flex items-center justify-between">
					<input
						...
						class="flex-1 accent-primary mr-3"
					/>
