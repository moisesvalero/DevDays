...
<InteractiveLabLayout
	hint="El layout pasa contexto; la página hija solo rellena el slot principal."
>
	{#snippet preview()}
		<div class="rounded-xl border-2 border-primary/30 p-1">
			<div class="rounded-t-lg bg-primary/10 px-4 py-2 text-xs font-bold text-primary">
				+layout.svelte
			</div>
