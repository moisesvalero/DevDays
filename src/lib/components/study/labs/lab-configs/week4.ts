...
export const day22: DayLabConfig = {
  ...
  labs: [
    ...
    block({
      ...
      fields: fields({ key: 'activo', label: 'Índice nav', kind: 'number', default: 0, min: 0, max: 2 }),
      derived: [
        {
          resultKey: 'nav',
          name: 'active',
...
export const day23: DayLabConfig = {
  ...
  labs: [
    ...
    block({
      ...
      fields: fields({ key: 'titulo', label: 'Título página', kind: 'string', default: 'Dashboard' }),
      derived: [
        {
          resultKey: 'main',
          name: 'slot',
...
export const day24: DayLabConfig = {
  ...
  labs: [
    ...
    block({
      ...
      fields: fields({ key: 'precio', label: 'Precio', kind: 'number', default: 29, min: 1, max: 200 }),
      derived: [
        {
          resultKey: 'ficha',
          name: 'producto',
