...
export const day1: DayLabConfig = {
  ...
  heroSubtitle: 'Toca la ficha, edita el código en vivo y observa cómo nombre, contador y precio alimentan la UI.',
  flowNodes: [
...
export const day3: DayLabConfig = {
  ...
  labs: [
    ...
    block({
      ...
      fields: fields({ key: 'logueado', label: 'Usuario logueado', kind: 'boolean', default: false }),
      derived: [
        {
          resultKey: 'cta',
          name: 'cta',
    ...
    block({
      ...
      fields: fields({ key: 'plan', label: 'Plan (1=free,2=pro,3=vip)', kind: 'number', default: 2, min: 1, max: 3 }),
      derived: [
        {
          resultKey: 'badge',
          name: 'badge',
...
export const day4: DayLabConfig = {
  ...
  labs: [
    ...
    block({
      ...
      fields: fields({ key: 'stock', label: 'Stock SKU', kind: 'number', default: 0, min: 0, max: 50 }),
      derived: [
        {
...
export const day5: DayLabConfig = {
  ...
  labs: [
    block({
      ...
      fields: fields({ key: 'factor', label: 'Factor', kind: 'number', default: 2, min: 1, max: 5 }),
      derived: [
        {
          resultKey: 'resultado',
    ...
    block({
      ...
      fields: fields({ key: 'umbral', label: 'Stock mínimo', kind: 'number', default: 1, min: 0, max: 10 }),
      derived: [
        {
          resultKey: 'count',
          name: 'disponibles',
...
export const day6: DayLabConfig = {
  ...
  labs: [
    block({
      ...
      fields: fields({ key: 'extra', label: 'Línea extra (€)', kind: 'number', default: 0, min: 0, max: 50 }),
      derived: [
        {
          resultKey: 'total',
          name: 'total',
    ...
    block({
      ...
      fields: fields({ key: 'cero', label: 'SKUs a 0', kind: 'number', default: 1, min: 0, max: 3 }),
      derived: [
        {
          resultKey: 'agotado',
          name: 'hayAgotado',
