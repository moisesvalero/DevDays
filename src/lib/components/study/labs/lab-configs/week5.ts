...
export const day29: DayLabConfig = {
  ...
  labs: [
    ...
    block({
      ...
      fields: fields({ key: 'estado', label: 'Estado (0-2)', kind: 'number', default: 1, min: 0, max: 2 }),
      derived: [
        {
          resultKey: 'badge',
          name: 'status',
...
export const day31: DayLabConfig = {
  ...
  labs: [
    block({
      ...
      fields: fields({ key: 'paso', label: 'Paso (0-3)', kind: 'number', default: 2, min: 0, max: 3 }),
      derived: [
        {
          resultKey: 'stage',
          name: 'pipeline',
...
export const day32: DayLabConfig = {
  ...
  labs: [
    block({
      ...
      fields: fields({ key: 'users', label: 'Usuarios meta', kind: 'number', default: 100, min: 10, max: 1000 }),
      derived: [
        {
          resultKey: 'pitch',
          name: 'valor',
    ...
    block({
      ...
      fields: fields({ key: 'dia', label: 'Día demo', kind: 'number', default: 2, min: 1, max: 35 }),
      derived: [
        {
          resultKey: 'flow',
          name: 'demo',
...
export const day33: DayLabConfig = {
  ...
  labs: [
    ...
    block({
      ...
      fields: fields({ key: 'pct', label: 'Retención %', kind: 'number', default: 80, min: 0, max: 100 }),
      derived: [
        {
          resultKey: 'r',
          name: 'resultado',
...
export const day34: DayLabConfig = {
  ...
  labs: [
    block({
      ...
      fields: fields({ key: 'seg', label: 'Segundos', kind: 'number', default: 15, min: 5, max: 30 }),
      derived: [
        {
          resultKey: 'hook',
          name: 'apertura',
      ...
      derived: [
        {
          ...
          expr: 'flujo demo',
          compute: (v) =>
            [v.login && '1.Login', v.lab && '2.Lab día 2', '3.Corrector'].filter(Boolean).join(' → ')
        }
      ]
    }),
    block({
