...
<InteractiveLabLayout hint="Edita nombre o edad en el spec — la ficha y el saludo se actualizan con template literals.">
  {#snippet preview()}
    <div class="mx-auto max-w-lg">
      <article class="lab-card-lift overflow-hidden rounded-2xl border border-outline-variant/50 bg-card shadow-lg">
        <div class="bg-gradient-to-r from-primary/20 to-tertiary/10 px-6 py-8">
          <div class="flex items-center gap-4">
            ...
            <div class="flex-1 space-y-3">
              <label class="block">
                <span class="text-[10px] font-bold uppercase text-on-surface-variant">Nombre (const)</span>
                <input
                  type="text"
              ...
              <label class="block">
                <span class="text-[10px] font-bold uppercase text-on-surface-variant">Edad (const)</span>
                <input
                  type="range"
                  min="18"
                  max="99"
        ...
        <div class="border-t border-outline-variant/40 px-6 py-5">
          <p class="text-[10px] font-bold uppercase tracking-widest text-primary">Salida · console.log</p>
