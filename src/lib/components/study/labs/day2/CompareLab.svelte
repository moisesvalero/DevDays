...
<InteractiveLabLayout
	hint="Cambia precioPlanA o precioPlanB en el código — la tarjeta «Recomendado» se mueve sola."
>
	{#snippet preview()}
		...
		>
			...
			<p class="text-sm text-on-surface">
				{#if empate}
					Ambos planes: <strong class="font-mono"><LiveValue value={values.precioPlanA} /> €</strong
					>
					— empate (
					<code>===</code>).
				{:else}
					Checkout usa: <strong class="font-mono text-primary"
						><LiveValue value={precioDestacado} /> €</strong
					>
				{/if}
			</p>
		</div>
